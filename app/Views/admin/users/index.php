...
<?= $this->section('scripts') ?>
    ...
    <script src="<?= base_url('assets/js/custom/user-management/users/list/table.js') ?>"></script>
    <script src="<?= base_url('assets/js/custom/user-management/users/list/export-users.js') ?>"></script>
    <script src="<?= base_url('assets/js/custom/user-management/users/list/add.js') ?>"></script>
<?= $this->endSection() ?>
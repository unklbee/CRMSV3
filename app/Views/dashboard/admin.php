                    ...
                    <div class="col-xl-6 mb-xl-10">
                        ...
                        <div class="card h-md-100">
                            ...
                            <div class="card-header align-items-center border-0">
                                <!--begin::Title-->
                                <h3 class="fw-bold text-gray-900 m-0">Pesanan Service Terbaru</h3>
                                <!--end::Title-->
                                <!--begin::Menu-->
                                <button class="btn btn-icon btn-color-gray-500 btn-active-color-primary justify-content-end"
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <div class="menu-content fs-6 text-gray-900 fw-bold px-3 py-4">Aksi Cepat
                                        </div>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu separator-->
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="#" class="menu-link px-3">Pesanan Baru</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="#" class="menu-link px-3">Pengguna Baru</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu separator-->
                                    <div class="separator mt-3 opacity-75"></div>
                                    ...
                                    <li class="nav-item mb-3 me-3 me-lg-6">
                                        ...
                                        <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden active w-80px h-85px py-4"
                                           data-bs-toggle="pill" href="#kt_stats_widget_2_tab_1">
                                            <!--begin::Icon-->
                                            <div class="nav-icon">
                                                <img alt="" src="<?= base_url('assets/media/svg/products-categories/t-shirt.svg') ?>"
                                                     class=""/>
                                            </div>
                                            <!--end::Icon-->
                                            <!--begin::Subtitle-->
                                            <span class="nav-text text-gray-700 fw-bold fs-6 lh-1">Laptop</span>
                                            <!--end::Subtitle-->
                                            <!--begin::Bullet-->
                                    ...
                                    <li class="nav-item mb-3 me-3 me-lg-6">
                                        ...
                                        <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                           data-bs-toggle="pill" href="#kt_stats_widget_2_tab_2">
                                            <!--begin::Icon-->
                                            <div class="nav-icon">
                                                <img alt="" src="<?= base_url('assets/media/svg/products-categories/gaming.svg') ?>"
                                                     class=""/>
                                            </div>
                                            <!--end::Icon-->
                                            <!--begin::Subtitle-->
                                            <span class="nav-text text-gray-700 fw-bold fs-6 lh-1">PC</span>
                                            <!--end::Subtitle-->
                                            <!--begin::Bullet-->
                                            <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                                            <!--end::Bullet-->
                    ...
                    <div class="mb-5 mb-xl-10">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-7">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-gray-800">Pesanan Perbaikan</span>
                                    <span class="text-gray-500 mt-1 fw-semibold fs-6">Rata-rata 57 pesanan per hari</span>
                                </h3>
                                <!--end::Title-->
                                <!--begin::Actions-->
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex flex-stack flex-wrap gap-4">
                                        ...
                                        <div class="d-flex align-items-center fw-bold">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Select-->
                                            <select class="form-select form-select-transparent text-graY-800 fs-base lh-1 fw-bold py-0 ps-3 w-auto"
